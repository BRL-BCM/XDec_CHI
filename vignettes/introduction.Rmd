...
```{r setup}
library(SlidingWindowExtension)
```
...
Cor2Genes=slidingWindow_2Gene_2CT(GeneExp = slidingWindow_2Gene_2CT::ExpressionMatrix,
                                  CTproportions = slidingWindow_2Gene_2CT::ProportionMatrix,
...
Cor2CT=slidingWindow_1Gene_CT_correlations(GeneExp = slidingWindow_2Gene_2CT::ExpressionMatrix,
                                  CTproportions = slidingWindow_2Gene_2CT::ProportionMatrix,
                                  GOI_anchor = "MSLN", #Gene samples are ordered by
                                  CT_anchor = "Classical.A", #Cell type of anchor gene
                                  CT_cor="Immune", #Cell type of correlated gene
